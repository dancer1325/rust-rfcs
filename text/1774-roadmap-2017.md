...
* goal
  * *2017 Rust Roadmap* /
    * follows [RFC 1728 Roadmap process design](https://github.com/rust-lang/rfcs/pull/1728)
    * focus: improve Rust's *productivity* /
      * retain: fast & reliable code
    * Rust
      * should 
        * have a
          * lower learning curve
          * pleasant edit-compile-debug cycle
          * 1.0-level crates for essential tasks
        * provide
          * a solid, but basic IDE experience
      ...
      * 's community 
        * should
          * provide mentoring | ALL levels
    * investigate
      * how to integrate with OTHER languages /
        * run the gamut from C -- to -- JavaScript
